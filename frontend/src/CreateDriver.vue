...
import DriverGatewayHttp from "./infra/gateway/DriverGatewayHttp.js";
...
const carPlate = ref("");
const driverId = ref("");
const driverGateway = inject("driverGateway") as DriverGatewayHttp;
...
<template>
  <div class="url">
    ...
    <button class="create-driver-button" @click="createDriver()">criar motorista</button>
